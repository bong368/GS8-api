(function() {
    ...
    angular
        .module('betApp')
        .controller('WithdrawnReportController', WithdrawnReportController);


    function WithdrawnReportController($socket, $auth, $state, $http, $rootScope, $scope, ngDialog, $DateTime, $excel, $timeout) {
        ...
        $scope.submitTicket = function() {
        	var req = {
                method: 'POST',
                url: baseUrl + 'api/transaction/report/withdrawn',
                data: $scope.ticket 
            }
