(function() {
    ...
    angular
        .module('betApp')
        .controller('BonusReportController', BonusReportController);


    function BonusReportController($socket, $auth, $state, $http, $rootScope, $scope, ngDialog, $DateTime, $excel, $timeout) {
